...
var client_id = process.env.SPOTIFY_CLIENT_ID; // client id
var client_secret = process.env.SPOTIFY_CLIENT_SECRET; // secret
var redirect_uri = 'http://localhost:3000/'; // redirect uri
...
// get user specific token if user is logged in
...
app.get('/track/:token/:trackId', function (req, res) {
  let info = {}
  // get track information (name, artist, etc)
